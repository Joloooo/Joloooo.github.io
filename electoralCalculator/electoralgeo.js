...
const createdynamic = () => {
  ...
  newDynamic.innerHTML = `
    <label id="partyLabel">პარტია<input type="text" class="partyInput" id="${partyInputID}"></label>
    <label id="percentLabel">პროცეტი (%)<input class="percentInput" id="${percentInputID}" type="number"></label>
  `;
